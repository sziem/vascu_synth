...
base_paths = {'/media/soenke/Data/Soenke/datasets/vascu_synth/small', '/media/soenke/Data/Soenke/datasets/vascu_synth/big'};
bgr_photons = 10;
max_photonss = [10 100 1000 10000 100000];  % high value: high variance of noise, but also high SNR default: 10000
wls = [260, 520, 780, 1040];  % nm (emission) default: 520
